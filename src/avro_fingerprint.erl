...
%%%-----------------------------------------------------------------------------
%%%
%%% Copyright (c) 2016-2017 Cogini Hong Kong Limited
%%%
...
%%% @reference See <a href="https://avro.apache.org/docs/1.7.7/api/java/org/apache/avro/SchemaNormalization.html">The source</a>
%%%-----------------------------------------------------------------------------
